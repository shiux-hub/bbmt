...
<template>
  ...
  >
    <div class="navbar w-full justify-between">
      ...
      <div class="flex items-center gap-1">
        VIEW/HIDE
        <CheckButton class="tooltip-bottom" tooltip="Uncheck">
          <div class="size-5 rounded-full border-2 border-primary" />
        </CheckButton>
        <CheckButton class="tooltip-bottom" tooltip="Success">
          <IconCheck class="size-5 text-green-400" />
        </CheckButton>
        <CheckButton class="tooltip-bottom" tooltip="Timeout">
          <IconClock class="size-5 text-gray-400" />
        </CheckButton>
        <CheckButton class="tooltip-bottom" tooltip="Error">
          <IconPlus class="size-5 rotate-45 text-red-400" />
        </CheckButton>
      </div>
  ...
  <div class="max-w-[100vw] px-6 pb-16 xl:pr-2">
    <div class="flex flex-row justify-between gap-6">
      <div class="flex-wrap overflow-x-hidden rounded-lg bg-base-200">
